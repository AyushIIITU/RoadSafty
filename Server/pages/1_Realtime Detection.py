...
# import geocoder  # Added for GPS tracking
...
class Detection(NamedTuple):
    ...
    score: float
    box: np.ndarray
    latitude: float  # Added GPS data field
    longitude: float
...
st.write("Detect the road damage in realtime using USB Webcam. This can be useful for on-site monitoring with personnel on the ground. Select the video input device and start the inference.")
